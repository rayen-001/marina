      ...
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Une messagerie simple pour vos questions de séjour, paiement et arrivée.
          </p>
        </div>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <div className="mt-1 truncate text-xs text-muted-foreground">
                        {conversation.reservationNumber ?? "Conversation générale"}
                      </div>
                    </div>
                    {conversation.unreadClientCount > 0 && (
          ...
          {selectedConversation ? (
            <>
              <div className="border-b border-border bg-card px-5 py-4">
                <div className="font-black text-primary">{selectedConversation.subject}</div>
